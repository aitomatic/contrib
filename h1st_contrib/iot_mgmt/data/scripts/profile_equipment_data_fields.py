...
def run(general_type: str, unique_type_group: str):
    ...
    eq_unq_tp_grp_parquet_df: S3ParquetDataFeeder = \
    ...
    for equipment_data_field in tqdm(eq_unq_tp_grp.equipment_data_fields.all()):   # noqa: E501
        ...
        if eq_data_field_name in eq_unq_tp_grp_parquet_df.possibleFeatureCols:
            # pylint: disable=protected-access

            if eq_unq_tp_grp_parquet_df.typeIsNum(eq_data_field_name):
                eq_unq_tp_grp_parquet_df._nulls[eq_data_field_name] = \
            ...
            eq_unq_tp_grp_data_field_profile: \
                ...
                EquipmentUniqueTypeGroupDataFieldProfile.objects.create(
                    ...
                    valid_proportion=(eq_unq_tp_grp_parquet_df
            ...
            if eq_unq_tp_grp_parquet_df.typeIsNum(eq_data_field_name):
                quartiles: dict = (eq_unq_tp_grp_parquet_df
                ...
                eq_unq_tp_grp_data_field_profile.outlier_rst_min = \
                    eq_unq_tp_grp_parquet_df.outlierRstMin(eq_data_field_name)
                ...
                eq_unq_tp_grp_data_field_profile.outlier_rst_max = \
                    eq_unq_tp_grp_parquet_df.outlierRstMax(eq_data_field_name)
